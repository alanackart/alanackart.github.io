...
stack & heap， 经常连在一起说， 但是堆和栈分别是不同的东西。[Memory Layout of C Programs](https://www.geeksforgeeks.org/memory-layout-of-c-program/)
...
stack overflow: 函数递归调用层次太深或递归条件不对无法返回

heap ocerflow: 申请的内存太大或者申请的内存未及时得到释放

# why does the storage class of global variable  be defined as 'extern'

回答没看明白，[Why is the storage class of global variables in C implicitly defined as “extern”?](https://stackoverflow.com/questions/42361320/why-is-the-storage-class-of-global-variables-in-c-implicitly-defined-as-extern)
